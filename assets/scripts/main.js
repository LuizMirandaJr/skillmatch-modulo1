...
async function carregarVagas() {
    ...
    function mostrarVagas() {
        ...
        const htmlVaga = document.getElementById("container-card")

        mostrarTitulo.innerHTML = `
        <div class="vagas-titulos">
        <h2 id="titulo-h2"><i class="bi bi-stars icon-title"></i> Vagas para você</h2>
        <p class="vagas-texto">Todas as vagas baseadas no seu perfil</p>
        </div>
        `
            ...
            <div class="job-card" id="job-card">
                    ...
                    <div class="compatibilidade">
                        ...
                        <div id="barra-bg" class="w3-round barra-bg barra">
                            <div id="barra-txt" class="w3-container w3-round barra-cor barra-txt" style="width:25%">25%
                            </div>
                        </div>
                    </div>
                </div>
